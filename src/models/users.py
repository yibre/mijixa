# 예시 코드
# 출처: https://github.com/Rehan-Ul-Haq/Fullstack-Todo-App-with-FastAPI-SQLModel-Nextjs-14/blob/main/backend/dailyDo-todo-app/dailydo_todo_app/main.py
# 참고하기 좋은 코드 2: https://github.com/ArjanCodes/examples/tree/main/2024/sqlmodel
